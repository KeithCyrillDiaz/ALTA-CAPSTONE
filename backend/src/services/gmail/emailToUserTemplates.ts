  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>
        ...
        <a href="mailto:${gmailCredentials.contactEmail}">${gmailCredentials.contactEmail}</a>.
      </p>
...
const rejectionEmailTemplate = (applicantName: string, jobPosition: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`
const interviewRejectionOutcomeEmailTemplate = (applicantName: string, jobPosition: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div class="container">
    <div class="content">
      ...
      <p>
        ...
        <a href="mailto:${gmailCredentials.contactEmail}" style="color: #1C3F60; text-decoration: none;">${gmailCredentials.contactEmail}</a>.
      </p>
      <p>
...
const welcomeEmailTemplate = (applicantName: string, jobPosition: string) =>  `
...
export const userGmailDesign = {
    'Thank You For Applying Email': (applicantName: string, jobPosition: string) => thankYouForApplyingEmailTemplate(applicantName, jobPosition),
    'Rejection Email': (applicantName: string, jobPosition: string) => rejectionEmailTemplate(applicantName, jobPosition),
    'Interview Rejection Email': (applicantName: string, jobPosition: string) => interviewRejectionOutcomeEmailTemplate(applicantName, jobPosition),
    'Welcome Email': (applicantName: string, jobPosition: string) => welcomeEmailTemplate(applicantName, jobPosition),
}